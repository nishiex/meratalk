...
export const metadata: Metadata = {
  title:
    "Conversational Intelligence | Insights From Every Customer Interaction · MeraTalk",
  description:
    "Conversational Intelligence analyzes 100% of customer calls, chats, and messages — surfacing trends, coaching opportunities, and revenue signals automatically.",
  openGraph: {
    title: "Conversational Intelligence | MeraTalk",
    description:
      "Analyze every customer interaction at scale. Spot churn risk, coaching gaps, and revenue signals automatically.",
    url: "https://meratalk.com/platform/conversational-intelligence",
    type: "website",
  },
}
...
const sixIconBoxes = [
  {
    ...
    description:
      "Surface the conversations that matter — competitor mentions, churn risks, product feedback, and compliance flags.",
  },
  {
...
const faqs = [
  {
    question:
      "How does Conversational Intelligence analyze our customer interactions across calls, chat, email, and other channels at enterprise scale?",
    answer:
  ...
  {
    question:
      "How long does it take to deploy Conversational Intelligence and start seeing meaningful insights from our existing call recordings?",
    answer:
  ...
  },
  {
    ...
    answer:
      "On well-defined rubrics, automated scoring typically agrees with senior QA analysts 90%+ of the time, and it covers every call rather than a tiny sample. We recommend running both in parallel for the first 30 days so you can calibrate the model and spot any edge cases your QA team disagrees with.",
  },
  {
    question:
  ...
  {
    question:
      "Does Conversational Intelligence integrate with our existing call recording, CRM, and business intelligence tools without significant engineering work?",
    answer:
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-[#5a6a7a] leading-relaxed mb-8 max-w-xl">
                Conversational Intelligence analyzes 100% of your customer interactions
            ...
            <div className="flex justify-center lg:justify-end">
              ...
              >
                <Image
                  ...
                  alt="Conversational Intelligence dashboard"
                  width={800}
                  height={500}
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-[#5a6a7a] leading-relaxed mb-6">
                Manual QA teams typically review 2–3% of calls. Conversational
        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-14">
            ...
            <p className="text-lg text-[#5a6a7a]">
              Every conversation contains signal. Conversational Intelligence finds it,
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-lg text-[#5a6a7a] leading-relaxed mb-8">
                ...
                Conversational Intelligence ingests every interaction, applies your
              ...
              <div className="space-y-5">
                {[
                  ...
                  <div key={step.num} className="flex gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-[#0d4a4a] mb-1">{step.title}</h3>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-[800px] mx-auto px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-lg text-[#5a6a7a]">
              What teams ask before they roll out Conversational Intelligence.
            </p>
          </div>
